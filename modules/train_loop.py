...
import torch
import glob
from modules.self_play import self_play_worker
from modules.chess_train import train_on_data, ChessNet
from modules.chess_model import load_model
from modules.chess_config import MODEL_PATH, DATA_PATH
